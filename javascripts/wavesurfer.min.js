...
var WaveSurfer = {
    ...
    drawBuffer: function() {
        if (this.params.fillParent && !this.params.scrollParent) var t = this.drawer.getWidth();
        else t = Math.round(this.getDuration() * this.params.minPxPerSec * this.params.pixelRatio);
        var e = this.backend.getPeaks(t);
        this.drawer.drawPeaks(e, t), this.fireEvent("redraw", e, t)
    },
...
WaveSurfer.Observer = {
    ...
    getId: function() {
        return "wavesurfer_" + Math.random()
            .toString(32)
            .substring(2)
    },
    max: function(t, e) {
    ...
    setFilters: function(t) {
        this.disconnectFilters(), t && t.length ? (this.filters = t, t.reduce(function(t, e) {
            ...
            .connect(this.gainNode)) : this.analyser.connect(this.gainNode)
    },
    ...
    destroy: function() {
        this.pause(), this.unAll(), this.buffer = null, this.disconnectFilters(), this.disconnectSource(), this.gainNode.disconnect(), this.scriptNode.disconnect(), this.analyser.disconnect()
    },
    load: function(t) {
    ...
    load: function(t, e, i) {
        ...
        s.controls = !1, s.autoplay = !1, s.src = t, s.addEventListener("error", function() {
    ...
    createElements: function() {
        ...
        this.waveCc = t.getContext("2d"), this.progressCc = e.getContext("2d")
    },
    updateWidth: function() {
        var t = Math.round(this.width / this.params.pixelRatio);
        [this.waveCc, this.progressCc].forEach(function(e) {
            e.canvas.width = this.width, e.canvas.height = this.height, this.style(e.canvas, {
                width: t + "px"
            })
        }, this), this.clearWave()
    },
    ...
    drawWave: function(t, e) {
        ...
        var r = this.height / 2,
            ...
            a = t.length,
            n = 1;
        this.params.fillParent && this.width != a && (n = this.width / t.length), this.waveCc.beginPath(), this.waveCc.moveTo(i, r), this.progressCc.beginPath(), this.progressCc.moveTo(i, r);
        for (var o = 0; a > o; o++) {
            var h = Math.round(t[o] * s);
            this.waveCc.lineTo(o * n + i, r + h), this.progressCc.lineTo(o * n + i, r + h)
        }
        this.waveCc.lineTo(this.width + i, r), this.progressCc.lineTo(this.width + i, r), this.waveCc.moveTo(i, r), this.progressCc.moveTo(i, r);
        for (var o = 0; a > o; o++) {
            var h = Math.round(t[o] * s);
            this.waveCc.lineTo(o * n + i, r - h), this.progressCc.lineTo(o * n + i, r - h)
        }
        this.waveCc.lineTo(this.width + i, r), this.waveCc.fill(), this.progressCc.lineTo(this.width + i, r), this.progressCc.fill(), this.waveCc.fillRect(0, r - i, this.width, i)
    },
